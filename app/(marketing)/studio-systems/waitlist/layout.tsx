...
export const metadata: Metadata = {
  ...
  description:
    'Join the Studio Systems waitlist and lock in founding member pricing at $55/month. Fashion production membership with live Q&A, Notion systems, and community.',
  keywords: [
