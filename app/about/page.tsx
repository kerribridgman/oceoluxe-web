          ...
          <div className="grid lg:grid-cols-5 gap-12 items-center">
            ...
            <div className="lg:col-span-3">
              ...
              <div className="space-y-6 text-lg text-[#967F71] font-light leading-relaxed">
                <p>
                  Before Oceo Luxe, Kerri built her production expertise across multiple fashion companies over more than a decade. She has cut over $10 million in production orders, tracked five concurrent seasons, and run four production lines while owning all buying and purchasing across each one. At one company, she managed active inventory across 15 suppliers and oversaw multiple sample rounds including inbound CITES samples for runway shows. At another, she was trusted to hire over 100 people based on her understanding of the founder&apos;s vision and standards.
                </p>
                <p>
                  The supplier and factory relationships she built over seven years have followed her across companies and industries. She has been the person negotiating with factories, auditing costing structures, and solving the production problems that most founders do not see until they become expensive.
                </p>
                <p>
