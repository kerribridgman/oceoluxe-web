          ...
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
            <div className="space-y-6">
              ...
              <p className="text-xl text-[#967F71] font-light leading-relaxed animate-fade-in-up">
                These systems reflect real-world production leadership, not generic digital templates. Built from the same frameworks used in private partnerships, now available as an operational system for brands ready to operate with precision.
              </p>
        ...
        <div className="max-w-4xl mx-auto px-6">
          ...
          <div className="space-y-6 text-lg text-[#967F71] font-light leading-relaxed mt-10">
            <p className="text-[#3B3937]">
              Most founders begin implementing core systems within the first 2&ndash;4 weeks, with full production workflows in place within 60&ndash;90 days depending on complexity.
            </p>
            <p>
              This is not passive content. The value comes from implementation. Founders who actively use the system during production cycles see the strongest results.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="section-spacing bg-[#3B3937]">
        <div className="max-w-3xl mx-auto px-6 text-center">
          ...
          <div className="mb-8">
            ...
            <p className="text-sm text-[#CDA7B2] mt-4 font-medium">Early access pricing for the first 20 founders</p>
          </div>
      ...
      <section className="section-spacing bg-white">
        <div className="max-w-3xl mx-auto px-6 text-center">
          ...
          <p className="text-sm text-[#967F71] mt-6 font-light">
            $77/month for early access • $111/month after the first 20
          </p>
        </div>
      </section>
