        ...
        <div className="max-w-6xl mx-auto px-6 relative z-10">
          <AnimateIn>
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
              ...
              <MediaSlot slotId="home-section-3-image" className="aspect-[4/5] w-full" />
            </div>
          </AnimateIn>
        </div>
      </section>
      ...
      <section className="py-20 lg:py-28 bg-[var(--color-charcoal)]">
        <div className="max-w-6xl mx-auto px-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <AnimateIn delay={100}>
              <div className="flex flex-col bg-[var(--color-ink)] border border-[var(--color-taupe)]/20 rounded-xl overflow-hidden h-full transition-all duration-500 hover:-translate-y-1 hover:shadow-[0_8px_40px_-8px_rgba(201,160,160,0.3)] hover:border-[var(--color-dusty-rose)]/30">
                <MediaSlot slotId="home-tier-op" className="aspect-[4/3] w-full rounded-none" />
            ...
            <AnimateIn delay={200}>
              <div className="flex flex-col bg-[var(--color-ink)] border border-[var(--color-taupe)]/20 rounded-xl overflow-hidden h-full transition-all duration-500 hover:-translate-y-1 hover:shadow-[0_8px_40px_-8px_rgba(201,160,160,0.3)] hover:border-[var(--color-dusty-rose)]/30">
                <MediaSlot slotId="home-tier-sa" className="aspect-[4/3] w-full rounded-none" />
                <div className="p-8 flex flex-col flex-1">
                  <h3 className="font-serif-display text-xl lg:text-2xl font-normal text-[var(--color-cream)] mb-3 tracking-tight">
                    Strategic Operational Alignment
                  </h3>
            ...
            <AnimateIn delay={300}>
              <div className="flex flex-col bg-[var(--color-ink)] border border-[var(--color-taupe)]/20 rounded-xl overflow-hidden h-full transition-all duration-500 hover:-translate-y-1 hover:shadow-[0_8px_40px_-8px_rgba(201,160,160,0.3)] hover:border-[var(--color-dusty-rose)]/30">
                <MediaSlot slotId="home-tier-ss" className="aspect-[4/3] w-full rounded-none" />
                <div className="p-8 flex flex-col flex-1">
                  <h3 className="font-serif-display text-xl lg:text-2xl font-normal text-[var(--color-cream)] mb-3 tracking-tight">
                    Studio Systems
                  </h3>
