...
import { ArrowLeft, Save, Upload, X, DollarSign, Package, Loader2, Search, Share2 } from 'lucide-react';
          ...
          <Card className="dashboard-card border-0">
            ...
            <CardContent className="pt-4 space-y-6">
              ...
              {formData.deliveryType === 'email' && (
                <div>
                  <Label htmlFor="accessInstructions">Email Delivery Content</Label>
                  <Textarea
                    id="accessInstructions"
                    value={formData.accessInstructions}
                    onChange={(e) => setFormData(prev => ({ ...prev, accessInstructions: e.target.value }))}
                    placeholder="What should be included in the delivery email? E.g., links, instructions, welcome message, next steps..."
                    rows={6}
                    className="mt-1"
                  />
                  <p className="text-xs text-gray-500 mt-1">
                    This content will be included in the purchase confirmation email sent to the customer.
                  </p>
                </div>
              )}
            </CardContent>
