...
import { leadNotes, quizLeads } from '@/lib/db/schema';
import { getUser } from '@/lib/db/queries';

// GET /api/quiz/[id]/notes - Get notes for a quiz lead
...
// POST /api/quiz/[id]/notes - Add a note to a quiz lead
