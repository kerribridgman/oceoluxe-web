...
export default function EntrepreneurCircleApplicationPage() {
      ...
      <div className="min-h-screen bg-white">
        ...
        <div className="max-w-3xl mx-auto px-4 py-20 text-center">
          ...
          <p className="text-xl text-gray-600 mb-8">
            Thank you for your interest in the Entrepreneur Circle. I'll review your application and get back to you within 48 hours.
          </p>
          <Link href="/">
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div>
                <Label htmlFor="interest" className="text-base font-medium text-gray-900">
                  What interests you about joining the Entrepreneur Circle? *
                </Label>
                <Textarea
                  id="interest"
